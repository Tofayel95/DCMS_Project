...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form runat="server">
            ...
            <table >
                ...
                <tr>
                    ...
                    <td>  
                        ...
                        <asp:ImageButton  runat="server" Height="27px" ImageUrl="~/Content/Images/Calendar_Green.png" OnClick="Unnamed1_Click" Width="43px"/>
                    </td>
                ...
                <tr>
                    <td>Fee</td>
                        <td><asp:TextBox ID="feeTextBox" runat="server"></asp:TextBox>
                    </td>
                </tr>
        ...
        <div ID="Test">
            <asp:Label runat="server" Visible="False" ID="billNumberLabel"></asp:Label>
        </div>
