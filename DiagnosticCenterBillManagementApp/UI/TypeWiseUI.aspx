...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form runat="server">
        ...
        <div align="center" id="Test" >
            <asp:GridView ID="typeWiseReportGridView" ShowHeaderWhenEmpty="True" runat="server" AutoGenerateColumns="False">
                <Columns>
        ...
        <div class="container">
            <table class="table ">
                <tr>
                    <td >
                        <input type="submit" onclick="PrintDiv('Test')" value="Print" /></td>                    
                <td>Total   
